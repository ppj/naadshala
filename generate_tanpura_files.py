...
JAWARI_BRIDGE_HEIGHT = 0.20    # lower bridge distance from rest (lower = more jawari)
JAWARI_JIVA_HEIGHT = 0.25      # upper bridge (jiva thread) — generates even harmonics (H4)
